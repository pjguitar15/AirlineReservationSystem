 ...
 * MainReservation
 */
public class MainReservation extends JFrame {
  ...
  private void topPanel() {
    ...
    topPanel.setBackground(Color.decode("#2c2c54"));
  ...
  private void rightPanel() {
    ...
    passengerDetailsLabel = new JLabel("PANEL DISABLED");
    passengerDetailsLabel.setBorder(new EmptyBorder(30, 0, 0, 0)); // top, left, bottom, right
    passengerDetailsLabel.setHorizontalAlignment(JLabel.CENTER);
    passengerDetailsLabel.setFont(new Font("Open Sans", Font.BOLD, 16));
    passengerDetailsLabel.setForeground(Color.lightGray);
    rightPanel.add(passengerDetailsLabel);
